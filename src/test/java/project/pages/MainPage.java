...
public class MainPage extends BasePage {
    ...
    private static final String XPATH_OF_LAST_COMMENT = ".//div[@id='wpt%s_%s']";
    private static final String XPATH_OF_LIKE_BUTTON =
            "//a[contains(@onclick, 'wall%s_%s')]//div[@class='like_button_icon']";
    private static final String XPATH_OF_SHOW_NEW_BUTTON = "//div[@id='feed_new_posts']";
    ...
    public boolean isPostTextAndUserRight(String userId, String postId, String expectedText) {
        String actualText = AqualityServices.getElementFactory().getLabel
                (By.xpath(String.format(XPATH_OF_LAST_COMMENT, userId, postId)), "Last comment").getText();
        return expectedText.equals(actualText);
    }

    private IButton showNewButton() {
        IButton showNewButton = AqualityServices.getElementFactory()
                .getButton(By.xpath(XPATH_OF_SHOW_NEW_BUTTON), "show new button");
    ...
    public boolean isPostDeleted(String userId, String postId) {
        return AqualityServices.getElementFactory().getLabel(By.xpath
                (String.format(XPATH_OF_LAST_COMMENT, userId, postId)), "Desired comment").state().isExist();
    }
